      ...
      <div className={wrapperClass}>
        ...
        >
          ...
          <Text size="sm" fw={600} style={{ flexGrow: 1 }}>
            {translate(item.routeName === "dashboard" ? "dashboard" : item.routeName === "content.news" ? "news" : item.routeName === "system.users" ? "users" : item.routeName === "system.auditLogs" ? "auditLogs" : item.label)}
          </Text>
          <IconChevronRight
            size={16}
            stroke={1.8}
