...
type AppBreadcrumbsProps = {
  ...
  /**
   * Includes routes marked `hiddenBreadcrumb` as plain text. Off by default so
   * News, Knowledge and Technology keep their existing breadcrumbs.
   */
          ...
          : route.name === "profile" || route.name.endsWith(".profile")
            ...
            : route.name.endsWith(".logging") || route.name === "system.auditLogs"
              ...
              : route.name === "dashboard"
                ? nav("dashboard")
                : route.name === "content.news"
                  ? nav("news")
                  : route.name === "content.news.detail"
                    ? nav("newsDetail")
